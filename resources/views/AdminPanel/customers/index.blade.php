                        ...
                        <table class="table table-bordered table-center table-hover bg-white mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center p-2">
                                       @if($customer->active ==1) <span class="text-success"> مفعل @else <span class="text-danger">  غير مفعل @endif</span>
                                    </td>
                                    <td class="text-center p-2">
                                    ...
                                    <td class="text-end p-3">
                                        <div class="tools-options d-flex justify-content-center">
                                            <div class="form-check form-switch p-0 pt-1">
                                                ...
                                                <input class="form-check-input" type="checkbox" onclick="window.location='{{ route("admin.customers.changeStatus",["id"=>$customer->id]) }}'" id="flexSwitchCheckChecked" @if($customer->active == 1) checked="" @endif>
