        ...
        <section class="related-products pt-4">
            <div class="container">
                ...
                <div class="row">
                    ...
                    @foreach ($product->relatedProducts->random($product->relatedProducts->count() > 4 ? 4 : $product->relatedProducts->count()) as $related_product)
                                                    ...
                                                    @if (auth()->user()->user_type == 'customer')
                                                        @if (favorite($related_product['id']))
                                                            <i class="fas fa-heart fa-lg rfavorite" id="rlike"
                                                                style="color: red;" product={{ $related_product['id'] }}></i>
                                                        @else
                                                            <i class="far fa-heart fa-lg rfavorite" id="rlike"
                                                                style="color: black;" product={{ $related_product['id'] }}></i>
                                                        @endif
                                                    @endif
                                                @endif
                                            </a>
