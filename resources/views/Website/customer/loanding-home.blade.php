            ...
            <div class="row align-items-center">
                <div class="col-md-5 order-md-1 order-2">
                    <div class="left-obahy-home-section">
                        ...
                        <form action="{{ route('create-store') }}" method="GET">
                            @csrf
                ...
                <div class="col-md-4">
                    <div class="card mb-5">
                        <div class="card-body plan-1 py-5">
                            <h5 class="card-title h1">$20.00</h5>
                            <p class="card-text font-weight-bold">Basic Pack</p>
                        </div>
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item mt-4">Extra Features</li>
                            <li class="list-group-item">Life Time Free Support</li>
                            <li class="list-group-item">Upgrate Options</li>
                            <li class="list-group-item">Full Access</li>
                        </ul>
                        <div class="card-body">
                            <a href="#" class="card-link a-card-body-white">Choose Plan</a>
                ...
                <div class="col-md-4">
                    <div class="card mb-5">
                        <div class="card-body plan-2 py-5">
                            <h5 class="card-title h1">$30.00</h5>
                            <p class="card-text font-weight-bold">Medium Pack</p>
                        </div>
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item mt-4">Extra Features</li>
                            <li class="list-group-item">Life Time Free Support</li>
                        ...
                        <div class="card-body">
                            <a href="#" class="card-link a-card-body-gold">Choose Plan</a>
                            <p class="my-3 p-card-body font-weight-bold">No Hidden Charges</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body plan-3 py-5">
                            <h5 class="card-title h1">$40.00</h5>
                            <p class="card-text font-weight-bold">Premium Pack</p>
                        </div>
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item mt-4">Extra Features</li>
                            <li class="list-group-item">Life Time Free Support</li>
