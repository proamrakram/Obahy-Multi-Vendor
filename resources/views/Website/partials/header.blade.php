        ...
        <div class="container">
            <div class="header-info d-flex justify-content-between align-items-center">
                ...
                <div class="header-logo">
                    <a href="{{ route('home') }}"> <img src="{{ asset('assets/images/icon/logo.svg') }}" alt=""
            ...
            <div class="modal-content">
                ...
                <div class="modal-body border-0 px-3 px-md-5">
                    <ul class="nav nav-tabs tab-style-1 justify-content-center border-0 mb-2 mb-md-4" id=""
                        ...
                        <li class="nav-item w-50">
                            <a class="nav-link" id="loginUser-tab" data-toggle="tab" href="#loginUser"
                                role="tab" aria-controls="loginUser" aria-selected="false">
                                Login
                            </a>
                        </li>
                    </ul>
