...
Route::get('/create-store-page', [App\Http\Controllers\Website\CustomerController::class, 'createStorePage'])->name('create-store-page');
...
Route::group(['prefix' => 'customer', 'as' => 'customer.', 'middleware' => ['auth', 'customer']], function () {
    ...
    Route::withoutMiddleware(['auth', 'customer'])->group(function () {
        Route::get('/home-page', [App\Http\Controllers\Website\CustomerController::class, 'index'])->name('home-page');

        /////////////////////////////////////////////
        Route::get('/category/{category_id}', [App\Http\Controllers\Website\ProductCategoryController::class, 'category'])->name('category');
        Route::post('/add-comment/{product_id}', [App\Http\Controllers\Website\ProductCategoryController::class, 'addComment'])->name('add-comment');
        Route::get('/single-product/{product_id}', [App\Http\Controllers\Website\ProductCategoryController::class, 'singleProduct'])->name('single-product');
        Route::post('/category-slider-price', [App\Http\Controllers\Website\ProductCategoryController::class, 'categorySliderPrice'])->name('category-slider-price');
        /////////////////////////////////////////////
        Route::post('/add-favorite', [App\Http\Controllers\Website\UserFavoritesController::class, 'addFavorite'])->name('add.favorite');

        /////////////////////////////////////////////
        Route::get('/cart', [App\Http\Controllers\Website\CartController::class, 'index'])->name('cart');
        Route::post('/add-to-cart', [App\Http\Controllers\Website\CartController::class, 'addToCart'])->name('cart.store');
        Route::post('/update-cart', [App\Http\Controllers\Website\CartController::class, 'updateCart'])->name('cart.update');
        Route::get('/remove/{rowId}', [App\Http\Controllers\Website\CartController::class, 'removeCart'])->name('cart.remove');
        // Route::post('/clear', [App\Http\Controllers\Website\CartController::class, 'clearAllCart'])->name('cart.clear');
        // Route::get('/cart-list', [App\Http\Controllers\Website\CartController::class, 'cartList'])->name('cart.list');
        // Route::get('/', [App\Http\Controllers\Website\ProductController::class, 'productList'])->name('products.list');

        /////////////////////////////////////////////
        Route::get('/checkout', [App\Http\Controllers\Website\CheckoutController::class, 'index'])->name('checkout.index');

        /////////////////////////////////////////////
        Route::get('/store-your-designers', [App\Http\Controllers\Website\StoreYourDesignersController::class, 'storeYourDesigners'])->name('store-your-designers');
        Route::get('/store-your-designers-details', [App\Http\Controllers\Website\StoreYourDesignersController::class, 'storeYourDesignersDetails'])->name('store-your-designers-details');

        /////////////////////////////////////////////
        Route::get('/sizes-girl',  [App\Http\Controllers\Website\StoreYourDesignersController::class, 'sizesGirl'])->name('sizes-girl');
        Route::get('/abaya-sizes', [App\Http\Controllers\Website\StoreYourDesignersController::class, 'abayaSizes'])->name('abaya-sizes');
        Route::get('/size-details', [App\Http\Controllers\Website\StoreYourDesignersController::class, 'sizeDetails'])->name('size-details');
        Route::get('/men-suit-sizes', [App\Http\Controllers\Website\StoreYourDesignersController::class, 'menSuitSizes'])->name('men-suit-sizes');
        Route::get('/jalabiya-sizes-men', [App\Http\Controllers\Website\StoreYourDesignersController::class, 'jalabiyaSizesMen'])->name('jalabiya-sizes-men');
        Route::get('/jalabiya-sizes-boys', [App\Http\Controllers\Website\StoreYourDesignersController::class, 'jalabiyaSizesBoys'])->name('jalabiya-sizes-boys');
        Route::get('/trousers-shirt-sizes', [App\Http\Controllers\Website\StoreYourDesignersController::class, 'TrousersShirtSizes'])->name('trousers-shirt-sizes');

        /////////////////////////////////////////////
        Route::get('/fabrics', [App\Http\Controllers\Website\FabricsController::class, 'fabrics'])->name('fabrics');
        Route::get('/suppliers', [App\Http\Controllers\Website\FabricsController::class, 'suppliers'])->name('suppliers');
        Route::get('/fabric-details', [App\Http\Controllers\Website\FabricsController::class, 'fabricDetails'])->name('fabric-details');
    });
});


Route::group(['prefix' => 'appearance_expert', 'as' => 'appearance_expert.'], function () {
    Route::get('/store-appearance-expert', [App\Http\Controllers\Website\AppearanceExpertController::class, 'storeAppearanceExpert'])->name('store-appearance-expert');
    Route::get('/store-appearance-expert-details/{product}', [App\Http\Controllers\Website\AppearanceExpertController::class, 'storeAppearanceExpertDetails'])->name('store-appearance-expert-details');
});


Route::group(['prefix' => 'fashion_designers', 'as' => 'fashion_designers.'], function () {
    Route::get('super-model', [App\Http\Controllers\Website\FashionDesignersController::class, 'superModel'])->name('super-model');
    Route::get('super-model-details', [App\Http\Controllers\Website\FashionDesignersController::class, 'superModelDetails'])->name('super-model-details');
    Route::get('store-fashion-details', [App\Http\Controllers\Website\FashionDesignersController::class, 'storeFashionDetails'])->name('store-fashion-details');
    Route::get('store-fashion-designers', [App\Http\Controllers\Website\FashionDesignersController::class, 'storeFashionDesigners'])->name('store-fashion-designers');
});
