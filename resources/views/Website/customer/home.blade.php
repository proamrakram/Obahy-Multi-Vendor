...
@section('content')
        ...
        <div class="container">
            <div class="row row-sm">
                ...
                <div class="col-md-8 col-sm">
                    @if ($left)
                        <a target="_blank" href="{{ $left->link }}">
                            <img class="img-fluid" src="{{ $left->add_image }}" />
                        </a>
                    @else
                        <a href="#">
                            ...
                            @foreach ($right_top as $ad)
                                <div class="intro-sm-img col-md-12 col-6  position-relative">
                                    <div
                                        ...
                                        <h5 class="h6-hero"><a target="_blank" href="{{ $ad->link }}"
                                                class='text-white text-decoration-none'>
                                                Designer Stars </a></h5>
                                        <a target="_blank" href="{{ $ad->link }}" class="icon-hero">
                                            <i class="fas fa-chevron-right"></i>
                                        </a>
                                    </div>
                                    <a target="_blank" href="#" class='link-img'>
                                        <img src="{{ $ad->add_image }}" class='img-fluid' alt="">
                                    </a>
                                </div>
                            @endforeach
                        @else
                            <div class="intro-sm-img col-md-12 col-6  position-relative">
                                ...
                                <a href="#" class='link-img'>
                                    <img src="{{ asset('assets/images/bg_img_intor1.png') }}" class='img-fluid'
                                        alt="">
                                </a>
                            </div>
                            ...
                            <div class="intro-sm-img col-md-12 col-6  position-relative">
                                ...
                                <a href="#" class='link-img'>
                                    <img src="{{ asset('assets/images/img_bg_into2.png') }}" class='img-fluid'
                                        alt="">
                                </a>
                            </div>
                        @endif
            ...
            <div class="row">
                <div class="col-md-8 col-sm">
                    <div class="special-left h-100 d-md-flex d-block justify-content-center flex-column pl-md-5 pl-0">
                        ...
                        @if ($center_top)
                            <a target="_blank" href="{{ $center_top->link }}"
                                class="btn btn-outline-primary mt-2  align-self-baseline btn-sm">Start
                                Now</a>
                        @endif
                    </div>
                </div>
                <div class="col-md-4 col-sm">
                    <div class="">
                        @if ($center_top)
                            <img class="mx-auto w-75 d-block pt-3 pr-5" src="{{ $center_top->add_image }}">
                        @else
                            <img class="mx-auto w-75 d-block pt-3 pr-5"
                                src="{{ asset('assets/images/img-specialleft.png') }}">
                        @endif
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="product-cat text-center mb-3">
                        <a target="_blank" href="{{ route('customer.store-your-designers') }}">
                            <img class="img-fluid mb-3" src="{{ asset('assets/images/woman-bags.png') }}">
                        </a>
                        <a target="_blank" href="{{ route('customer.store-your-designers') }}"
                            class="btn btn-outline-primary">Your Designer</a>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="product-cat text-center mb-3">
                        <a href="{{ route('appearance_expert.store-appearance-expert') }}">
                            <img class="img-fluid mb-3" src="{{ asset('assets/images/women-fashion.png') }}">
                        </a>
                        <a target="_blank" href="{{ route('appearance_expert.store-appearance-expert') }}"
                            class="btn btn-outline-primary">Appearance Experts</a>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="product-cat text-center mb-3">
                        <a target="_blank" href="{{ route('customer.fabrics') }}">
                            <img class="img-fluid mb-3" src="{{ asset('assets/images/fabric.png') }}">
                        </a>
                        <a target="_blank" href="{{ route('customer.store-your-designers') }}"
                            class="btn btn-outline-primary">Fabrics And Ores</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="wedding-guest pt-0 pt-md-5 pb-md-5 pb-3">
        <div class="container">
            @if ($center_bottom)
                <a target="_blank" href="{{ $center_bottom->link }}">
                    <img class="img-fluid" src="{{ $center_bottom->add_image }}">
                </a>
            @else
                <a href="#">
                        ...
                        <div class="product-style-1 text-center">
                            <div class="product-image">
                                <a href="{{ route('customer.single-product', $custom_made_product->id) }}"> <img
                                        class="img-fluid" src="{{ asset('assets/images/women-fashion.png') }}">
                                </a>
                    ...
                    <div class="item">
                        <div class="product-style-1 text-center">
                            <div class="product-image border rounded">
                                <a href="{{ route('customer.category', $category->id) }}"> <img class="img-fluid"
                                        src="{{ asset('assets/images/shop-design.png') }}">
                                </a>
                            </div>
                            <div class="product-content">
    ...
    <section class="latest-fabrics mt-4 pb-4">
        <div class="container">
            ...
            <div class="row">
                @foreach ($new_products->random($new_products->count() > 3 ? 3 : $new_products->count()) as $new_product)
                    <div class="col-md-4 col-6">
