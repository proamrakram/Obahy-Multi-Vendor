...
<div class="container-fluid">
        ...
        <div class="bg-white mt-3">
            <div class="d-flex justify-content-between p-4  bg-white   rounded-top border-bottom heading-with-shape">
                <h6 class="fw-bold mb-0 h4"> تعديل الاشتراك  </h6>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <div class="row">
                                        <div class="col-6">
                                            <input type="text" value="{{$store->store_name_ar }}" name="store_name_ar" class="form-control @error('store_name_ar') is-invalid @enderror" id="NameAr" placeholder="الاسم بالعربية">
                                        ...
                                        <div class="col-6">
                                             <input type="text" value="{{ $store->store_name_en}}" name="store_name_en" class="form-control col-6   @error('store_name_en') is-invalid @enderror" id="NameEn" placeholder="الاسم بالانجليزية">
                                             @error('store_name_en')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="row">
                                ...
                                <div class="col-10">
                                    <input type="text"  value="{{ $store->phone_number}}" name="phone_number" class="form-control   @error('phone_number') is-invalid @enderror " id="Phone" placeholder="رقم الهاتف">
                                    @error('phone_number')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                            ...
                            <div class="row">
                                ...
                                <div class="col-10">
                                   ...
                                   @foreach($countries as $country)
                                                        <option value="{{$country->id}}" @if($store->store_country==$country->id )selected @endif>{{$country->country_name_ar}} </option>
                                                        @endforeach
                                   </select>
                                   @error('store_country')
                                                    <span class="invalid-feedback" role="alert">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="row">
                                ...
                                <div class="col-10">
                                    <input type="date"  value="{{ $store->subscription_start_date}}" name="subscription_start_date" class="form-control   @error('subscription_start_date') is-invalid @enderror" id="Phone" placeholder="تاريخ بداية الاشتراك">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="row">
                                ...
                                <div class="col-10">
                                    <input type="text"  value="{{ $store->store_domain }}" name="store_domain" class="form-control   @error('store_domain') is-invalid @enderror" id="Date" placeholder="اكتب اسم النطاق">
                                    @error('store_domain')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="row">
                                ...
                                <div class="col-10">
                                <select name="name" id="" class="form-select form-control   @error('name') is-invalid @enderror">
...
$("#state-dropdown").append('<option value="'+value.id+'">'+value.city_name_ar+'</option>');
}); 
}
});
});   
